...
namespace SalesWebMvc.Data
{
    ...
    {
        private Model.SalesWebMvcContext _context;

        public SeendingService(Model.SalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            SalesRecord r2 = new SalesRecord(2, new DateTime(2021, 09, 25), 10000.0, SaleStatus.Billed, s3);
            ...
            SalesRecord r26 = new SalesRecord(26, new DateTime(2021, 10, 20), 6000.0, SaleStatus.Billed, s4);
